...
function addresse (){
    ...
    const fenetre = document.location.href;

    if (fenetre== "https://projetpizza.netlify.app/index.html" || fenetre == "https://projetpizza.netlify.app/" || fenetre == "http://localhost:3000/index.html" || fenetre == "http://localhost:3000/"){
        afficher6Pizzas ();
    }

    if (fenetre == "https://projetpizza.netlify.app/html/pizza.html" || fenetre == "http://localhost:3000/html/pizza.html"){
        afficherAllPizzas();
    }
